This is my Currency Converter project I have built all by myself. It sends request to API to obtain JSON file and than uses provided data for caluclation. It features 36 currencies.
